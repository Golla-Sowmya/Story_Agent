...
## Output Format
Output a valid JSON object, following the EXACT format below:
{{
    "story_title": "xxx",
...
## Example Output
{{
    "story_title": "The Little Bear's Adventure",
    "story_outline": [
        {{"chapter_title": "Chapter 1: The Forest Discovery", "chapter_summary": "Little Bear finds a mysterious path in the forest and decides to explore it."}},
        {{"chapter_title": "Chapter 2: Meeting New Friends", "chapter_summary": "Bear meets a wise owl and a playful rabbit who join the adventure."}},
        {{"chapter_title": "Chapter 3: The Hidden Treasure", "chapter_summary": "The friends discover a magical treasure that teaches them about friendship."}},
        {{"chapter_title": "Chapter 4: Home Sweet Home", "chapter_summary": "Bear returns home with new friends and valuable lessons about courage and kindness."}}
    ]
}}

IMPORTANT: You must use exactly the keys "story_title" and "story_outline". Each chapter must have exactly "chapter_title" and "chapter_summary" keys.
...
## Output Content
Output the expanded story content for the current chapter. The result should be a Python list where each element corresponds to the plot of one page of the storybook.

Example format: ["Page 1 content here", "Page 2 content here", "Page 3 content here"]
